...
-- Date: Fri, 11 Dec 2015 14:43:28 +0100
...
SET autocommit=0;
INSERT INTO `_blog_article` VALUES (1,'ghj','&nbsp;hjghj ghjghjg','2015-12-10','ghj','ghj','ghj',NULL,1);
...
--
-- Table structure for table `_galerie_photo`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_galerie_photo` (
  `ID_galerie_photo` int(11) NOT NULL AUTO_INCREMENT,
  `nom_dossier_absolu` varchar(255) NOT NULL,
  `nom_galerie` varchar(50) DEFAULT NULL,
  `nom_dossier` varchar(255) NOT NULL,
  `afficher_navigation` int(11) DEFAULT NULL,
  `afficher_front` int(2) DEFAULT NULL,
  `afficher_popup` int(1) DEFAULT NULL,
  `nb_image_page` int(11) NOT NULL,
  `date_creation` date NOT NULL,
  `balise_title` varchar(70) DEFAULT NULL,
  `url` varchar(92) DEFAULT NULL,
  `meta_description` varchar(160) DEFAULT NULL,
  `ID_identite` int(11) NOT NULL,
  PRIMARY KEY (`ID_galerie_photo`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `_galerie_photo`
--

LOCK TABLES `_galerie_photo` WRITE;
/*!40000 ALTER TABLE `_galerie_photo` DISABLE KEYS */;
SET autocommit=0;
INSERT INTO `_galerie_photo` VALUES (1,'E:/serveurweb/plugins/NEW_MVC_per/modules/galerie_photo/images/gj','gj','/plugins/NEW_MVC_per/modules/galerie_photo/images/gj',0,1,0,6,'2015-12-10','','gj','',1);
/*!40000 ALTER TABLE `_galerie_photo` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

--
-- Table structure for table `_galerie_photo_image`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_galerie_photo_image` (
  `ID_galerie_photo_image` int(11) NOT NULL AUTO_INCREMENT,
  `nom_image` varchar(255) DEFAULT NULL,
  `nom_image_popup` varchar(255) DEFAULT NULL,
  `titre` varchar(50) DEFAULT NULL,
  `description` text,
  `balise_alt` varchar(70) DEFAULT NULL,
  `ordre` int(11) NOT NULL,
  PRIMARY KEY (`ID_galerie_photo_image`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `_galerie_photo_image`
--

LOCK TABLES `_galerie_photo_image` WRITE;
/*!40000 ALTER TABLE `_galerie_photo_image` DISABLE KEYS */;
SET autocommit=0;
INSERT INTO `_galerie_photo_image` VALUES (1,'resized_56699c78add6a.jpg','resized_popup_56699c78add6a.jpg','ghj','ghj','ghj',1);
/*!40000 ALTER TABLE `_galerie_photo_image` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

--
-- Table structure for table `_galerie_photo_liaison_image`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_galerie_photo_liaison_image` (
  `ID_liaison_galerie_photo_image` int(11) NOT NULL AUTO_INCREMENT,
  `ID_galerie_photo_image` int(11) NOT NULL,
  `ID_galerie_photo` int(11) NOT NULL,
  PRIMARY KEY (`ID_liaison_galerie_photo_image`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `_galerie_photo_liaison_image`
--

LOCK TABLES `_galerie_photo_liaison_image` WRITE;
/*!40000 ALTER TABLE `_galerie_photo_liaison_image` DISABLE KEYS */;
SET autocommit=0;
INSERT INTO `_galerie_photo_liaison_image` VALUES (1,1,1);
/*!40000 ALTER TABLE `_galerie_photo_liaison_image` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

--
-- Table structure for table `_galerie_photo_page`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_galerie_photo_page` (
  `ID_galerie_photo_page` int(11) NOT NULL AUTO_INCREMENT,
  `ID_galerie_photo` int(11) DEFAULT NULL,
  `ID_page` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID_galerie_photo_page`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `_galerie_photo_page`
--

LOCK TABLES `_galerie_photo_page` WRITE;
/*!40000 ALTER TABLE `_galerie_photo_page` DISABLE KEYS */;
SET autocommit=0;
/*!40000 ALTER TABLE `_galerie_photo_page` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;
...
SET autocommit=0;
INSERT INTO `configuration` VALUES (1,'MVC','mvc@mvc.com','kiki ouioui','http://127.0.0.1/plugins/NEW_MVC/','web@clicand.com','2015-12-10');
...
SET autocommit=0;
INSERT INTO `module` VALUES (5,'livre_or/','http://library.anthony-pilloud.fr/livre_or.zip','livre d\'or',1,1,1,'fa-book'),(4,'blog/','http://library.anthony-pilloud.fr/blog.zip','blog',1,1,1,'fa-newspaper-o'),(7,'galerie_photo/','http://library.anthony-pilloud.fr/galerie_photo.zip','galerie photo',1,1,1,'fa-photo');
...
-- Dump completed on: Fri, 11 Dec 2015 14:43:28 +0100
