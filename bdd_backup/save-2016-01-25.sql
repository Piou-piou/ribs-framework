...
-- Date: Mon, 25 Jan 2016 09:29:58 +0100
...
SET autocommit=0;
INSERT INTO `cache` VALUES (2,'gestion-contenus-index.php',0,NULL),(3,'gestion-droits-acces-index.php',0,NULL),(4,'gestion-comptes-index.php',0,NULL),(5,'gestion-comptes-mon-compte.php',0,NULL),(6,'gestion-contenus-modifier-contenu.php',0,NULL),(7,'configuration-index.php',0,NULL),(8,'configuration-module.php',0,NULL),(9,'contacter-support.php',0,NULL);
...
SET autocommit=0;
INSERT INTO `configuration` VALUES (1,'MVC','mvc@mvc.com','kiki ouioui','http://127.0.0.1/plugins/NEW_MVC/','web@clicand.com','2016-01-22',1,1,NULL);
...
SET autocommit=0;
INSERT INTO `module` VALUES (1,'livre_or/','livre d\'or',0,0,1,'fa-book','http://library.anthony-pilloud.fr/livre_or.zip'),(2,'blog/','blog',0,0,1,'fa-newspaper-o','http://library.anthony-pilloud.fr/blog.zip'),(3,'galerie_photo/','galerie photo',0,0,1,'fa-photo','http://library.anthony-pilloud.fr/galerie_photo.zip');
...
-- Dump completed on: Mon, 25 Jan 2016 09:29:58 +0100
