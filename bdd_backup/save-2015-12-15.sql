...
-- Date: Tue, 15 Dec 2015 09:13:21 +0100
...
CREATE TABLE `configuration` (
  ...
  `contenu_dynamique` int(11) DEFAULT NULL,
...
SET autocommit=0;
INSERT INTO `configuration` VALUES (1,'MVC','mvc@mvc.com','kiki ouioui','http://127.0.0.1/plugins/NEW_MVC/','web@clicand.com','2015-12-14',1,1,NULL);
...
CREATE TABLE `configuration_compte` (
  `ID_configuration_compte` int(11) NOT NULL AUTO_INCREMENT,
  `valider_inscription` int(11) DEFAULT NULL,
  `activer_inscription` int(11) DEFAULT NULL,
  `activer_connexion` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID_configuration_compte`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `module` VALUES (5,'livre_or/','http://library.anthony-pilloud.fr/livre_or.zip','livre d\'or',0,0,1,'fa-book'),(4,'blog/','http://library.anthony-pilloud.fr/blog.zip','blog',0,0,1,'fa-newspaper-o'),(7,'galerie_photo/','http://library.anthony-pilloud.fr/galerie_photo.zip','galerie photo',0,0,1,'fa-photo');
...
-- Dump completed on: Tue, 15 Dec 2015 09:13:21 +0100
