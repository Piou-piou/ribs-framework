		...
		<form  action="<?=WEBROOT?>installation-ribs/controller/bdd/install" method="POST">
			...
			<div class="modifier-contenu">
				<div class="bloc">
					...
					<input type="text" name="db_host" value="<?=$db_host?>" type-val="string" min="3" max="100" required/>
				</div>
				...
				<div class="bloc">
					...
					<input type="text" name="db_type" value="<?=$db_type?>" type-val="string" min="3" max="15" required/>
				</div>
				...
				<div class="bloc">
					...
					<input type="text" name="db_name" value="<?=$db_name?>" type-val="string" min="3" max="50" required/>
				</div>
				...
				<div class="bloc">
					...
					<input type="text" name="db_user" value="<?=$db_user?>" type-val="string" min="3" max="50" required/>
				</div>

				<div class="bloc">
					<label class="label" for="db_pass">Mot de passe de la base de données</label>
					<input type="text" name="db_pass" value="<?=$db_pass?>"/>
				</div>
			</div>
